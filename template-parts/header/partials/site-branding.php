...
$site_title = apply_filters( 'burcon_site_title', $title );
...
$site_description = apply_filters( 'burcon_site_description', $description );
...
$logo = apply_filters( 'burcon_logo', $output );

/**
 * Output header content.
 */
do_action( 'burcon_before_header_content' ); ?>
...
<?php do_action( 'burcon_after_header_content' );