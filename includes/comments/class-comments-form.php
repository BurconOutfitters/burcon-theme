 ...
 * Post comments form arguments.
 */
class Burcon_Theme_Comments_Form {
    ...
    public static function args() {
        ...
        $fields =  apply_filters( 'burcon_comments_signup_fields', [
        ...
        $comments_args = apply_filters( 'burcon_comments_labels', [
...
$controlled_chaos_comments_form = new Burcon_Theme_Comments_Form;